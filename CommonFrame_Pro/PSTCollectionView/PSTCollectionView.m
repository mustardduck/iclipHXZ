...
- (PSTCollectionViewLayoutAttributes *)layoutAttributesForItemAtPoint:(CGPoint)point
{
    return [[self.collectionViewLayout layoutAttributesForElementsInRect:CGRectMake(point.x, point.y, 1, 1)] lastObject];
}
...
//            [_updateCompletionHandler release];
